...
class Solution(object):
    ...
    """
    Question:
    source: ‘abc’. subsequences: a,b,c,ab,ac,bc,abc target: ‘abcac’Can the target string
    be constructed by concatenating the subsequences of the source string? follow up: What is the minimum number of
    concatenations required?
